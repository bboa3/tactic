...
from src.POSsTransactions.services.utils.content.utils.find_rows import findValuesAndVolumesRows
from src.POSsTransactions.services.utils.content.utils.formatter import rowFormatter
from src.POSsTransactions.domain.requiredFields.pos import Indicator

name: str = 'Pagamentos'

def paymentsFormatter(
